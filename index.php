                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <div class="text-center">
                                        <img src="img/logo/logo.jpg" style="width:100px;height:100px">
                                        <br><br>
	...
	if($userType == "ClassTeacher"){
      ...
      if($num > 0){
       ...
       // echo $_SESSION['Id'];die();
        ...
        $query = "SELECT * FROM tbladminstaff WHERE emailAddress = '$username' AND password = '$password'";
        $rs = $conn->query($query);
        $num = $rs->num_rows;
        $rows = $rs->fetch_assoc();
        ...
        $_SESSION['emailAddress'] = $rows['emailAddress'];
          ...
          echo "<script type = \"text/javascript\">
          window.location = (\"AdminStaff/index.php\")
          </script>";
        }
